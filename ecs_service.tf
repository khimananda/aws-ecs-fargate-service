...
resource "aws_ecs_task_definition" "this" {
  ...
  container_definitions = templatefile("${path.root}/templates/task_defination_${var.template_suffix}.json", var.container)
...
resource "aws_ecs_service" "this" {
  ...
  cluster         = data.aws_ecs_cluster.portpro.arn
